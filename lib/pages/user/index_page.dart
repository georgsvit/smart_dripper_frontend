...
class _UsersIndexState extends State<UsersIndexPage> {
  ...
  void _deleteElement(String id, String role) async {
    var result;
    try {
      await deleteUser(id, role).then((value) => result = value);
  ...
  Widget build(BuildContext context) {
    if (users == null) {
      ...
      return Scaffold(
        appBar: AppBar(
          title: Text(AppLocalization.of(context).translate('users_label')),                          
        ),
        body: Center(
          child: Column(
            ...
            children: <Widget>[
              Center(
                child: Text(
                  AppLocalization.of(context).translate('users_list_label'),
                ...
                child: RaisedButton(
                  ...
                  onPressed: () => {
                    showDialog(context: context, builder: (BuildContext context) {                                  
                      return UserFormPage(new UserResponse("", "", "", "", "", ""));
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(element.name + ' ' + element.surname, style: TextStyle(fontSize: 20),),
                                  Text(AppLocalization.of(context).translate('role') + ': ' + AppLocalization.of(context).translate(element.role.toLowerCase() + '_label')),
                                ],
                              ),
                              IconButton(
                                      ...
                                      return AlertDialog(
                                        ...
                                        actions: <Widget>[
                                          ...
                                          FlatButton(
                                            ...
                                            onPressed: () {
                                              _deleteElement(element.id, element.role);
                                            },
                                          ),
                                        ],
                                      );
