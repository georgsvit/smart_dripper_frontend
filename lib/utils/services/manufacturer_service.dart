...
Future<List<ManufacturerResponse>> getAllManufacturers() async {
  ...
  if (response.statusCode == 200) {
    var list = (json.decode(response.body) as List).map((data) => ManufacturerResponse.fromJson(data)).toList();
...
Future<ManufacturerResponse> getManufacturer(String id) async {
  ...
  if (response.statusCode == 200) {
    ...
    var element = ManufacturerResponse.fromJson(json.decode(response.body));
